    ...
    <div className="flex-1 bg-white">
      ...
      <header className="bg-white/95 backdrop-blur-md sticky top-0 w-full z-40 shadow-sm">
        <div className="flex justify-between items-center max-w-[1280px] mx-auto px-4 md:px-6 h-16 md:h-20">
          <div onClick={() => scrollTo('home')} className="flex items-center gap-2 md:gap-3 cursor-pointer hover:scale-95 transition-transform">
            <span className="material-symbols-outlined text-[#003769] font-bold text-xl md:text-2xl" style={{ fontVariationSettings: "'FILL' 1" }}>medical_services</span>
            <span className="text-lg md:text-xl font-bold text-[#003769] tracking-tight">MediCare Premium</span>
          </div>
          
          {/* Desktop Nav */}
          <nav className="hidden lg:flex gap-8 items-center">
            <button onClick={() => scrollTo('home')} className="text-sm font-bold text-[#003769] relative after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:bg-[#003769]">Home</button>
            <button onClick={() => scrollTo('services')} className="text-sm text-gray-500 font-semibold hover:text-[#003769] transition-colors">Services</button>
            <button onClick={() => scrollTo('doctors')} className="text-sm text-gray-500 font-semibold hover:text-[#003769] transition-colors">Doctors</button>
            <button onClick={() => scrollTo('appointments')} className="text-sm text-gray-500 font-semibold hover:text-[#003769] transition-colors">Appointments</button>
          </nav>
          
          <div className="flex items-center gap-3">
            <button 
              onClick={() => scrollTo('appointments')}
              className="bg-[#003769] text-white text-[12px] md:text-sm font-bold px-4 md:px-7 py-2 md:py-3 rounded-xl hover:bg-[#003d7a] transition-all shadow-md hidden sm:block active:scale-95"
            >
              Book Appointment
            </button>
            <button 
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              className="lg:hidden text-[#003769] p-2 bg-gray-50 rounded-lg active:scale-95"
            >
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col p-4 space-y-4">
                <button onClick={() => { setIsMenuOpen(false); scrollTo('home'); }} className="text-left text-sm font-bold text-[#003769]">Home</button>
                ...
                <button 
                  ...
                  className="bg-[#003769] text-white text-sm font-bold px-7 py-3 rounded-xl w-full active:scale-95"
                >
                  Book Appointment
                </button>
              </div>
      ...
      <main>
          ...
          <div className="max-w-[1280px] mx-auto px-4 md:px-6 relative z-20 w-full">
            <div className="max-w-2xl">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 bg-[#003769]/10 text-[#003769] text-[10px] md:text-[11px] font-bold px-3 md:px-4 py-1 md:py-1.5 rounded-full mb-4 md:mb-8 uppercase tracking-widest"
              >
              ...
              >
                Your Health,<br/><span className="text-[#003769]">Our Priority</span>
              </motion.h1>
              <motion.p 
              ...
              >
                <button 
                  onClick={() => scrollTo('appointments')}
                  className="bg-[#003769] text-white text-sm font-bold px-6 md:px-10 py-3 md:py-4 rounded-xl hover:bg-[#003d7a] transition-all shadow-xl shadow-[#003769]/20 flex items-center justify-center gap-2 group active:scale-95"
                >
                  Book Consultation
                ...
                <button 
                  ...
                  className="bg-white text-[#003769] border-2 border-[#003769]/10 text-sm font-bold px-6 md:px-10 py-3 md:py-4 rounded-xl hover:bg-slate-50 transition-colors active:scale-95 shadow-sm"
                >
                  Our Services
                </button>
              </motion.div>
        ...
        <section id="stats" className="max-w-[1280px] mx-auto px-4 md:px-6 relative z-30 -mt-8 md:-mt-16 lg:-mt-24">
          <div className="bg-[#003769] text-white py-10 md:py-20 rounded-2xl md:rounded-3xl shadow-2xl shadow-[#003769]/20 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
        ...
        <section id="services" className="max-w-[1280px] mx-auto px-4 md:px-6 py-24 md:py-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              >
                <div className="w-14 h-14 bg-indigo-50 text-[#003769] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#003769] group-hover:text-white transition-colors">
                  <span className="material-symbols-outlined text-2xl">{service.icon}</span>
                </div>
                <h3 className="text-xl font-bold text-[#111c2d] mb-3">{service.title}</h3>
                <p className="text-slate-500 text-sm leading-relaxed mb-6">{service.desc}</p>
                <button onClick={() => scrollTo('appointments')} className="text-[#003769] text-sm font-bold flex items-center gap-2 group-hover:gap-3 transition-all">
                  Book Now
        ...
        <section id="doctors" className="bg-slate-50 py-24 md:py-32">
          <div className="max-w-[1280px] mx-auto px-4 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 gap-6">
              ...
              <button onClick={() => scrollTo('doctors')} className="text-[#003769] font-bold flex items-center gap-2 hover:gap-3 transition-all">
                View All Doctors
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12">
              {[
                ...
                <motion.div 
                  key={i}
                  whileHover={{ y: -12 }}
                  className="bg-white rounded-[2.5rem] p-6 md:p-8 shadow-sm border border-slate-100 hover:shadow-2xl hover:shadow-[#003769]/5 transition-all group flex flex-col items-center text-center"
                >
                  <div className="relative mb-8">
                    ...
                    <div className="absolute top-0 -left-4 bg-[#003769] text-white px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider z-20 shadow-md">
                      {doc.exp}
                    </div>
                  </div>
                  ...
                  <button 
                    onClick={() => scrollTo('appointments')}
                    className="w-full py-4 rounded-2xl bg-slate-50 text-[#003769] font-bold text-sm hover:bg-[#003769] hover:text-white transition-all active:scale-95 shadow-sm"
                  >
                    Book Appointment
                  </button>
                </motion.div>
        ...
        <section id="appointments" className="max-w-[1280px] mx-auto px-4 md:px-6 py-24 md:py-32">
          <div className="bg-[#111c2d] rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 lg:p-20 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#003769]/20 to-transparent"></div>
            ...
            <div className="relative z-10 w-full lg:w-1/3">
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-3xl">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-[#003769] rounded-full flex items-center justify-center">
      ...
      <footer className="bg-slate-50 w-full pt-16 md:pt-32 pb-12 md:pb-20 mt-16 md:mt-32 border-t border-gray-100">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-20 max-w-[1280px] mx-auto px-4 md:px-6">
          <div className="col-span-1 sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-3 mb-6 md:mb-8 cursor-pointer" onClick={() => scrollTo('home')}>
              <span className="material-symbols-outlined text-[#003769] font-bold text-2xl" style={{ fontVariationSettings: "'FILL' 1" }}>medical_services</span>
              <span className="text-xl md:text-2xl font-bold text-[#003769] tracking-tight">MediCare</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-5 text-sm md:text-[15px] font-semibold text-gray-600">
              <li><button onClick={() => scrollTo('services')} className="hover:text-[#003769] transition-colors">Cardiology</button></li>
              <li><button onClick={() => scrollTo('services')} className="hover:text-[#003769] transition-colors">Neurology</button></li>
              <li><button onClick={() => scrollTo('services')} className="hover:text-[#003769] transition-colors">Pediatrics</button></li>
            </ul>
          </div>
          <div>
            <h4 className="text-[11px] md:text-[13px] font-bold text-gray-400 uppercase tracking-widest mb-4 md:mb-10">Resources</h4>
            <ul className="space-y-3 md:space-y-5 text-sm md:text-[15px] font-semibold text-gray-600">
              <li><button onClick={() => scrollTo('home')} className="hover:text-[#003769] transition-colors">About Us</button></li>
              <li><button onClick={() => scrollTo('appointments')} className="hover:text-[#003769] transition-colors">Patient Portal</button></li>
              <li><button onClick={() => scrollTo('home')} className="hover:text-[#003769] transition-colors">Careers</button></li>
            </ul>
          </div>
          <div>
            <h4 className="text-[11px] md:text-[13px] font-bold text-gray-400 uppercase tracking-widest mb-4 md:mb-10">Support</h4>
            <ul className="space-y-3 md:space-y-5 text-sm md:text-[15px] font-semibold text-gray-600">
              <li><button onClick={() => scrollTo('appointments')} className="hover:text-[#003769] transition-colors">Help Center</button></li>
              <li><button onClick={() => scrollTo('appointments')} className="hover:text-[#003769] transition-colors">Contact Us</button></li>
              <li><button onClick={() => scrollTo('home')} className="hover:text-[#003769] transition-colors">Legal</button></li>
            </ul>
          </div>
        </div>
        <div className="max-w-[1280px] mx-auto px-4 md:px-6 mt-12 md:mt-24 pt-8 md:pt-12 border-t border-gray-100/60 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
          ...
          <div className="flex gap-6 md:gap-8">
             <button onClick={() => scrollTo('home')} className="text-[10px] md:text-[12px] font-bold text-gray-400 uppercase tracking-widest hover:text-[#003769]">Privacy</button>
             <button onClick={() => scrollTo('home')} className="text-[10px] md:text-[12px] font-bold text-gray-400 uppercase tracking-widest hover:text-[#003769]">Terms</button>
          </div>
        </div>
      </footer>
    </div>
